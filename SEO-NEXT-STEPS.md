...
- **H2 — Tarif-Zahl (BLOCKIERT).** Sitewide steht widersprüchlich „über 30" /
  „30+" (Hero, Feature-Grid, Feature-Seite) vs. „57 Tarife von 26
  Gesellschaften" (Pricing). Du hast „scopen" gewählt — sag mir **welche Zahl
  wofür gilt** (z.B. „30+ voll modelliert" vs. „57 hinterlegt"), dann
  vereinheitliche ich alle Stellen konsistent. Betroffen: `index.md` (Z. ~12,
  ~60), `_funktionen/fondspolice-etf-vergleich.md` (Z. ~27, ~58).
...
C1 (Hero-LCP), M2 (Meta-Descriptions), M3 (Sitemap lastmod), M5
(robots/noindex), M6 (Preis-Typing), H3 (Header-Bug + Mobile-Hamburger),
H1-Struktur (SoftwareApplication-Schema, Orphan-Link, Frage-H2s, FAQ-Block),
H4-Schema, M4 (Bilder → WebP). Details: Commit-History.
